...
import logo from "../../assets/Puravankara_Official_Logo.png"; // Importing Prestige Logo
      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-0 flex flex-wrap items-center justify-between py-[4px] z-40">
        ...
        <div className="lg:hidden flex items-center">
          <button
            ...
            className="inline-flex items-center w-8 h-8 justify-center text-black hover:bg-skyblue2Color focus:outline-none"
        ...
        >
          <ul className="flex flex-col p-4 md:p-0 md:flex-row gap-8 w-full justify-between text-white">
        ...
        <div className="hidden lg:flex items-center">
          <a
            ...
            className="flex items-center bg-[#dbe7f3] text-black px-3 py-2 rounded-lg shadow-lg hover:bg-opacity-90 transition"
          >
