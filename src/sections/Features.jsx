...
export const Features = () => {
  ...
  const featuresData = [
    { id: 1, title: 'Project Size', value: '24.5 Acres' },
    { id: 2, title: 'Possession', value: '2030 ' },
    { id: 3, title: 'Starting Price', value: '₹ 1.1 Cr*' },
    { id: 4, title: 'Units', value: '2, 3 & 4 BHK' },
  ];

  return (
    <section className="w-full bg-PrestigeGrey">
      <div className="bg-[#022f5a] text-PrestigeGrey w-full transform -translate-y-1/2">
